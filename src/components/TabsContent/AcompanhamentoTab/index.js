...
export const AcompanhamentoTab = ({ acompanhamentoResponse }) => {
  const token = JSON.parse(sessionStorage.getItem('@token'));

  const [acompanhamento, setacompanhamento] = useState(acompanhamentoResponse);
  ...
  return (
    <div className="acompanhamento-tab">
